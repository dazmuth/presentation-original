define({"en": {
    ...
    "general": {
        ...
        "copyright": {"message": "© 2019 Xyleme. All rights reserved."},
        "sidebarLeft": {
    ...
    "components": {
        ...
        "presenterView": {"title": {"message": "Presenter View"}},
    ...
    "elements": {
        "choiceBranch": {
            ...
            "reset": {"message": "Reset"},
            "acceptanceCheckMessage": {"message": "I understand that any existing progress from this point on will be lost"},
            "infoMessage": {"message": "Resetting this choice will remove any and all progress you may have made from this point on, even if you make the same choice as you did previously."}
        },
